...
CMDs[#CMDs + 1] = {NAME = 'animationpack / animpack [Name]', DESC = 'Makes your character use any animation pack (must be by roblox to replicate)'}
CMDs[#CMDs + 1] = {NAME = 'animationlist / animlist', DESC = 'Prints all animation packs you can use (with animationpack)'}
